...
| Login-based identity (UID 2.0, LiveRamp) | Authentication-gated identity | Excludes anonymous visitors (~70–90% of traffic); requires consent wall |
...
3. **Works without login:** Anonymous visitors (70–90% of traffic) get consistent cross-domain identity without creating accounts or authenticating.
...
| **Google ecosystem lock-in** | GA4 360 pricing starts at **$50,000/year**; data is processed through Google's infrastructure with limited data sovereignty | Google pricing |
...
| Pricing | $100K–$500K+/year (Experience Cloud) | $50K+/year (GA4 360) | Tiered licensing (see Section 7) |
